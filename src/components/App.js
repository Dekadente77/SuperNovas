  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <b style={{color: '#ffff02'}}>SuperNovas</b> are a group of 6.666 intergalatic girls with outstanding <br/> style and out of these world vibes, creating a fun and diverse universe <br/> in the midst of the nft world.<br/><br/>   
